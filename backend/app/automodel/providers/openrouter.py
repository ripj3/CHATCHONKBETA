...
class OpenRouterProvider(BaseProvider):
    ...
    async def _load_models(self) -> None:
        ...
        try:
            ...
            for model_data in models_data.get("data", []):
                ...
                supported_tasks = self._determine_supported_tasks(model_id, name, description)
    ...
    def _determine_supported_tasks(self, model_id: str, name: str, description: str) -> set:
        ...
        if any(term in model_lower for term in ["gpt", "claude", "llama", "mistral", "qwen"]):
    ...
    def _supports_functions(self, model_id: str) -> bool:
        ...
        function_models = [
            "gpt-4", "gpt-3.5-turbo", "claude-3", "mistral"
        ]
