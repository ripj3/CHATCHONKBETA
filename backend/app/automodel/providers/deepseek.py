...
This module provides integration with DeepSeek's API for the AutoModel system.
DeepSeek models excel at reasoning, coding, and analytical tasks.
...
logger = logging.getLogger("chatchonk.automodel.providers.deepseek")
